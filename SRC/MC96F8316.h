...
sfr16 T1ADR    =  0xBC; // Timer 1 A Data Low Register
sfr   T1ADRL   =  0xBC; // Timer 1 A Data Low Register
sfr   T1ADRH   =  0xBD; // Timer 1 A Data High Register
sfr16 T1BDR    =  0xBE; // Timer 1 B Data Low Register
...
sfr16 T2ADR    =  0xC4; // Timer 2 A Data Low Register
sfr   T2ADRL   =  0xC4; // Timer 2 A Data Low Register
sfr   T2ADRH   =  0xC5; // Timer 2 A Data High Register
sfr16 T2BDR    =  0xC6; // Timer 2 B Data Low Register
